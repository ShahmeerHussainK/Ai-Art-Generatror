...
const RemixModal = ({ isVisible, onClose }) => {
  ...
  return (
    ...
    <View style={styles.blurContainer}>
      <BlurView style={styles.blurView} blurType="dark" blurAmount={500}>
          ...
          <View style={[styles.autoLayoutVertical9, styles.rectanglePosition,{ backgroundColor: theme.background } ]}>
            <View style={[styles.frame, styles.frameLayout]}>
              <View style={[styles.rectangle1, styles.frameLayout]} />
            </View>
            <Text style={[styles.remix, styles.remixSpaceBlock, { color: theme.text }]}>{t('Remix')}</Text>
            <Image
            ...
            <View style={styles.remixSpaceBlock}>
              <TouchableOpacity style={styles.autoLayoutHorizontal2}
                ...
                <Image
                  ...
                  source={isDarkMode ? require("../assets/iconlyregularoutlineimage-3.png") : require("../assets/inputimageLight.png")}
                />
                <Text style={[styles.useAsInput, styles.nameFlexBox, { color: theme.text }]}>
              ...
              >
                <Image
                  ...
                  source={isDarkMode ? require("../assets/iconeditimageoutline-componentadditional-icons1.png") : require("../assets/editartworkLight.png")}
                />
                <Text style={[styles.useAsInput, styles.nameFlexBox, { color: theme.text }]}>
              ...
              >
                <Image
                  ...
                  source={isDarkMode ? require("../assets/iconlyregularlightedit.png") : require("../assets/Edit.png")}
                />
                <Text style={[styles.useAsInput, styles.nameFlexBox, { color: theme.text }]}>
                  {t('Try this Style')}
                </Text>
