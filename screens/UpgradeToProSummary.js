...
const UpgradeToProSummary = () => {
  ...
  return (
    <View
      style={[
        styles.UpgradeToProSummary,{ backgroundColor: theme.background },
        styles.UpgradeToProSummaryLayout,
      ]}
    >
      <View style={styles.autoLayoutVertical}>
        ...
        >
          <View style={[styles.autoLayoutVertical1, styles.autoBorder, { backgroundColor: theme.promptbackground }]}>
            <View style={[styles.autoLayoutHorizontal2, styles.autoFlexBox, ]}>
              <Text style={[styles.subscription, styles.text4Layout, { color: theme.text }]}>
                {t('Subscription')}
              </Text>
              <Text style={[styles.months, styles.text5Typo, { color: theme.text }]}>{t('6 months')}</Text>
            </View>
            <View
              style={[
            ...
            >
              ...
              <Text style={[styles.months, styles.text5Typo, { color: theme.text }]}>$24.00</Text>
            </View>
          </View>
          <View style={[styles.autoLayoutVertical2, styles.autoSpaceBlock, { backgroundColor: theme.promptbackground }]}>
            <View style={[styles.autoLayoutHorizontal2, styles.autoFlexBox]}>
              <Text style={[styles.subscription, styles.text4Layout, { color: theme.text }]}>
                {t('Amount')}
              </Text>
            ...
            >
              <Text style={[styles.subscription, styles.text4Layout, { color: theme.text }]}>{t('Tax')}</Text>
              <Text style={[styles.months, styles.text5Typo, { color: theme.text }]}>$1.00</Text>
            </View>
            <Image
              style={[
            ...
            >
              ...
              <Text style={[styles.months, styles.text5Typo, { color: theme.text }]}>$25.00</Text>
            </View>
          </View>
        </View>
      </View>
...
export default UpgradeToProSummary;
