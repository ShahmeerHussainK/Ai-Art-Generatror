...
// const DarkImagesToPaintingUploa1 = () => {
//   const navigation = useNavigation();
//   const [selectedImage, setSelectedImage] = useState(null);
//   const [showImage, setShowImage] = useState(true)
//   const [loading, setLoading] = useState(false);
//   const [loadingText, setLoadingText] = useState("");
//   const prompt = "convert image into painting";
//   const type = "remix";
//   const strength = '75';
//   const control = "scribble";
//   const steps = "50";
//   const cfg = "7";
//   const style_id = 29;
//   const pickImage = () => {
...
//       setLoading(true);
//       setLoadingText("Please wait, generating...");


//       const asImageSrc = await uploadImageGeneration(selectedImage, prompt, "21", type, strength, control, steps, cfg);
//       navigation.navigate('GeneratingArtwork', { asImageSrc, prompt, style_id, selectedImage, type, strength, control, steps, cfg });
//       setLoading(false);
...
//               Upload your image, and we’ll generate an AI painting version for
//               you.
//             </Text>
//           </View>
//           {showImage && (
...
//           onPress={uploadImage}
//         >
//           <Text style={[styles.button, styles.textLayout]}>Generate</Text>
//         </TouchableOpacity>
//       </View>
//       {loading && (
  ...
  return (
    <View style={styles.PhotoToAnimeUploadPhoto}>
      <View style={[styles.autoLayoutVertical, styles.autoLayoutVerticalPosition]}>
        <View style={[styles.navbardefaultDarktrueCom, styles.darktrueFlexBox]}>
          <View style={styles.autoLayoutHorizontal}>
            <Image style={[styles.typelogoDefaultComponentl, styles.gobackLayout]} resizeMode="cover" source={require("../assets/typelogo-default-componentlogo8.png")} />
            <Pressable style={[styles.gobackLayout]} onPress={() => navigation.goBack()}>
              <Image style={styles.icon} resizeMode="cover" source={require("../assets/goback7.png")} />
            </Pressable>
          </View>
          <Text style={[styles.titleSection, styles.titleTypo]}>{t('Images to Painting')}</Text>
          <Image style={[styles.autoLayoutHorizontal1, styles.gobackLayout]} resizeMode="cover" source={require("../assets/auto-layout-horizontal.png")} />
        </View>
        <View style={[styles.elementsuploadImagesToGene, styles.autoLayoutVertical1FlexBox]}>
          <View style={styles.autoLayoutVertical1FlexBox}>
            <Text style={[styles.uploadYourPhoto, styles.titleTypo]}>{t('Upload an Image')}</Text>
            <Text style={styles.uploadYourPhoto1}>{t('Upload your image, and we’ll generate an AI painting version for you.')}</Text>
          </View>
          {showImage && (
            <View>
              <TouchableOpacity style={[styles.autoLayoutVertical2, styles.autoSpaceBlock]} activeOpacity={0.0} onPress={pickImage}>
                {showImage && (
                  <Image style={styles.iconlycurvedoutlineupload} resizeMode="cover" source={require("../assets/iconlycurvedoutlineupload1.png")} />
                )}
          ...
          {selectedImage && (
            <View style={[styles.frame, styles.frameSpaceBlock]}>
              <Image style={[styles.artworkRatio11ArtworkS, styles.artworkLayout]} resizeMode="cover" source={{ uri: selectedImage.uri }} />
            </View>
          )}
        </View>
      </View>
      <View style={[styles.buttonprimaryDarktrueCom, styles.autoLayoutVerticalPosition]}>
        <TouchableOpacity style={[styles.buttonpillTypepillIconf, styles.rectangleLayout]} activeOpacity={0.0} onPress={uploadImage}>
...
export default DarkImagesToPaintingUploa1;