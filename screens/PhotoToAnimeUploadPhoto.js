...
import { uploadImageGeneration } from '../helper';
import { useTheme } from "../context/ThemeContext";
import { generateImage } from '../helper';
import { useTranslation } from 'react-i18next';


const PhotoToAnimeUploadPhoto = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const asImageSrc = await uploadImageGeneration(selectedImage, prompt, "21", type, "43", "canny", "50", "15");
      ...
      >
        ...
        >
          <View style={styles.autoLayoutVertical1FlexBox}>
            ...
            {t('You can upload photo We’ll generate a Anime version for you.')}
            </Text>
          </View>
          {showImage && (
            <View>
...
export default PhotoToAnimeUploadPhoto;