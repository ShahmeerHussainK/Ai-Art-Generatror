...
const UpscalePhotoUpload = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const asImageSrc = await uploadImageGeneration(selectedImage, prompt, "21", type, "43", "canny", "50", "15","https://api.vyro.ai/v1/imagine/api/upscale");
      ...
      >
        ...
        >
          <View style={styles.autoLayoutVertical1FlexBox}>
            ...
            {t('You can upload photo We’ll Upscale or resize your photo or selfie.')}
            </Text>
          </View>
          {showImage && (
...
export default UpscalePhotoUpload;