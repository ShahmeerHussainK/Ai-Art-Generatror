...
const ShareToFeedSuccessful = ({ isVisible, onClose }) => {
    ...
    <Modal isVisible={isVisible} onBackdropPress={onClose} useNativeDriver={true}>
      <View style={[styles.modalContent, { backgroundColor: theme.background }]}>
        ...
        <View style={styles.autoLayoutVertical}>
          <Text style={[styles.modalTitle]}>{t('Successful')}!</Text>
          <Text style={[styles.loremIpsumDolor,{ color: theme.text }]}>
          {t('Your artwork has been successfully shared to the feed. Now everyone in the community can see your artwork.')}
          </Text>
        </View>
        ...
        >
          ...
          >
            <Text style={[styles.button, styles.buttonTypo]}>{t('View Artwork')}</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.autoLayoutVertical1, styles.autoFlexBox]}
          activeOpacity={0.0}
        ...
        >
          <View
            style={[styles.buttonpillTypepillIconf1,{ backgroundColor: theme.promptbackground }, styles.buttonpillFlexBox]}
          >
            <Text style={[styles.button, styles.buttonTypo,  { color: theme.canceltext }]}>{t('Back to Home')}</Text>
          </View>
        </TouchableOpacity>
      </View>
    </Modal>
...
export default ShareToFeedSuccessful;
