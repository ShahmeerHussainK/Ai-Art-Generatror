...
const DownloadSuccessful = ({ isVisible, onClose }) => {
    ...
    <Modal isVisible={isVisible} onBackdropPress={onClose} useNativeDriver={true}>
      <View style={[styles.modalContent, { backgroundColor: theme.background }]}>
        ...
        <View style={styles.autoLayoutVertical}>
          <Text style={[styles.modalTitle, { color: theme.text }]}>{t('Download Successful')}!</Text>
          <Text style={[styles.loremIpsumDolor, { color: theme.text }]}>
          {t('Please wait')}...
            {'\n'}{t('You will be get this photo in your Phone Downloads.')}
          </Text>
        </View>
        <BallIndicator
