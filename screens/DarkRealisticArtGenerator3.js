...
const DarkRealisticArtGenerator3 = () => {
    ...
    <View style={styles.PhotoToAnimeUploadPhoto}>
        ...
        >
          <View style={styles.autoLayoutVertical1FlexBox}>
            ...
            <Text style={styles.uploadYourPhoto1}>
              {t('You can upload sketches, anime, artwork, paintings, and more.',t('We’ll generate a realistic art version for you.'))}
            </Text>
          </View>
          {showImage && (
      ...
      >
        <TouchableOpacity
          ...
          activeOpacity={0.0}
          onPress={uploadImage}
        // navigation.navigate("DarkRealisticArtGenerator2")
        >
...
export default DarkRealisticArtGenerator3;