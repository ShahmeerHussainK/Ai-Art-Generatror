...
const RealisticArtUploadPhoto = () => {
  ...
  const prompt = 'Convert this image into more realistic';
  const style_id = 22;
  const pickImage = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      const asImageSrc = await uploadImageGeneration(selectedImage, prompt, "22", "remix", "100", "lineart", "50", "15");
      ...
      <View style={[styles.autoLayoutVertical, styles.autoLayoutVerticalPosition]}>
        ...
        <View style={[styles.elementsuploadImagesToGene, styles.autoLayoutVertical1FlexBox]}>
          <View style={styles.autoLayoutVertical1FlexBox}>
            ...
            {t('You can upload sketches, anime, artwork, paintings, and more. We’ll generate a realistic art version for you.')}
            </Text>
          </View>
          {showImage && (
            <View>
...
export default RealisticArtUploadPhoto;