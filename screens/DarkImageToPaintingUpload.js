...
const DarkImageToPaintingUpload = () => {
    ...
    <View style={[styles.PhotoToAnimeUploadPhoto, { backgroundColor: theme.background }]}>
      <View style={[styles.autoLayoutVertical, styles.autoLayoutVerticalPosition]}>
        <View style={[styles.navbardefaultDarktrueCom, styles.darktrueFlexBox]}>
          ...
          <Text style={[styles.titleSection, styles.titleTypo,  { color: theme.text }]}>{t('Images to Painting')}</Text>
        ...
        <View style={[styles.elementsuploadImagesToGene, styles.autoLayoutVertical1FlexBox]}>
          <View style={styles.autoLayoutVertical1FlexBox}>
            <Text style={[styles.uploadYourPhoto, styles.titleTypo,  { color: theme.text }]}>{t('Upload an Image')}</Text>
            <Text style={[styles.uploadYourPhoto1, { color: theme.text }]}>{t('Upload your image, and we’ll generate an AI painting version for you.')}</Text>
          </View>
          {showImage && (
            <View>
      ...
      <View style={[styles.buttonprimaryDarktrueCom,  { backgroundColor: theme.background }, styles.autoLayoutVerticalPosition]}>
...
export default DarkImageToPaintingUpload;