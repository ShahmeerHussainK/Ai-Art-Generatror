    ...
    <ScrollView>
      <View style={[styles.darkFollowers, { backgroundColor: theme.background }]}>
        <View style={[styles.autoLayoutVertical, styles.autoLayoutVerticalPosition]}>
          <TextInput
            style={[styles.navbardefaultDarktrueCom,{ backgroundColor: theme.promptbackground },{ color: theme.text }, styles.autoLayoutVertical2SpaceBlock]}
          ...
          />
          <ScrollView
            style={[styles.autoLayoutVertical1, styles.autoLayoutVertical1SpaceBlock]}
          ...
          >
            <View style={styles.autoLayoutHorizontal}>
              <TouchableOpacity
                style={styles.activetrueStylenoneTheme}
                onPress={() => navigation.navigate("DarkFollowers")}
                activeOpacity={0.0}
              >
              ...
              <TouchableOpacity
                style={styles.activetrueStylenoneTheme}
                onPress={() => navigation.navigate("DarkFollowing")}
                activeOpacity={0.0}
              >
                <Text style={[styles.horizontalTab1, styles.chipsTypo]}>
                  {t('Following')}
                </Text>
                <View style={[styles.autoLayoutVertical2, styles.rectangleSpaceBlock]}>
                  <View style={styles.rectangle1} />
                </View>
              </TouchableOpacity>
            </View>
            {/* First block */}
            <View style={[styles.typedefaultListDarktrue, styles.autoLayoutVertical1SpaceBlock]}>
                ...
                <View style={styles.autoLayoutVertical3}>
                  <Text style={[styles.name,{ color: theme.text }]}>{t('creativepalette')}</Text>
              ...
              <Pressable
                style={[styles.sizesmallTypefilledIcon, styles.sizesmallIconSpaceBlock]}
              >
            ...
            <View style={[styles.typedefaultListDarktrue, styles.autoLayoutVertical1SpaceBlock]}>
              ...
              <View style={styles.autoLayoutHorizontal1}>
                ...
                <View style={styles.autoLayoutVertical3}>
                  <Text  style={[styles.name,{ color: theme.text }]}>{t('artfulinkling')}</Text>
                  <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                    {t('Max Bennett Gallery')}
                  </Text>
                </View>
              </View>
              <Pressable
                style={[styles.sizesmallTypeborderIcon, styles.sizesmallIconSpaceBlock]}
              >
                <Text style={[styles.chips1, styles.chipsLayout]}>{t('Following')}</Text>
              </Pressable>
            </View>
            {/* Third block */}
            <View style={[styles.typedefaultListDarktrue, styles.autoLayoutVertical1SpaceBlock]}>
              ...
              <View style={styles.autoLayoutHorizontal1}>
                ...
                <View style={styles.autoLayoutVertical3}>
                  <Text  style={[styles.name,{ color: theme.text }]}>{t('designdynamo')}</Text>
                  <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                    {t('Emily Mitchell')}
                  </Text>
                </View>
            ...
            {/* Continue with remaining blocks using the same pattern */}
            <View
            style={[
          ...
          >
            ...
            <View style={styles.autoLayoutHorizontal1}>
              ...
              <View style={styles.autoLayoutVertical3}>
                <Text  style={[styles.name,{ color: theme.text }]}>{t('colorsplash')}</Text>
                <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                {t('Ethan Color Splash')}
                </Text>
              </View>
            </View>
            <View
          ...
          >
            ...
            <View style={styles.autoLayoutHorizontal1}>
              ...
              <View style={styles.autoLayoutVertical3}>
                <Text  style={[styles.name,{ color: theme.text }]}>{t('sketchmaven')}</Text>
                <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                {t('Olivia Lawson Sketch')}
                </Text>
              </View>
            </View>
            <View
          ...
          >
            ...
            <View style={styles.autoLayoutHorizontal1}>
              <Image
                style={styles.typedefaultComponentavatarIcon}
                resizeMode="cover"
                source={require("../assets/typedefault-componentavatar11.png")}
              />
              <LinearGradient
                style={[styles.autoLayoutHorizontal12, styles.autoShadowBox]}
                locations={[0, 1]}
                colors={["#235dff", "#4f7dff"]}
                useAngle={true}
                angle={-73.83}
              ...
              <View style={styles.autoLayoutVertical3}>
                <Text  style={[styles.name,{ color: theme.text }]}>{t('visualwhiz')}</Text>
                <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                {t('Gabriel Sullivan')}
                </Text>
              </View>
          ...
          >
            ...
            <View style={styles.autoLayoutHorizontal1}>
              ...
              <View style={styles.autoLayoutVertical3}>
                <Text  style={[styles.name,{ color: theme.text }]}>{t('craftycreations')}</Text>
                <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                {t('Lily Thompson Creations')}
                </Text>
              </View>
            </View>
            <View
          ...
          >
            ...
            <View style={styles.autoLayoutHorizontal1}>
              ...
              <View style={styles.autoLayoutVertical3}>
                <Text  style={[styles.name,{ color: theme.text }]}>{t('abstractvisionary')}</Text>
                <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                {t('Noah Ramirez')}
                </Text>
              </View>
          ...
          >
            ...
            <View style={styles.autoLayoutHorizontal1}>
              ...
              <View style={styles.autoLayoutVertical3}>
                <Text  style={[styles.name,{ color: theme.text }]}>{t('imaginarybrush')}</Text>
                <Text style={[styles.information, styles.chipsLayout, { color: theme.text }]}>
                {t('Sophia Collins Dreams')}Sophia Collins Dreams
                </Text>
              </View>
            </View>
            <View
